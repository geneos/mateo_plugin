...
public class VPAttribute extends JComponent implements VEditor,ActionListener {
    ...
    public void actionPerformed( ActionEvent e ) {
        ...
        /**
         * Se remueve el cambio de "M_AttributeSetInstance_ID" por "M_AttributeSetInstanceTo_ID"
         * para poder seleccionar partidas en movimientos (Solo tiene M_Product_ID y no M_ProductTo_ID)
         */
        /*
        ...
        } else    // Selection
        {
            ...
            if( masi == null ) {
               ...
               //     ADialog.error( m_WindowNo,this,"PAttributeNoInstanceAttribute" );
                    ...
                    //No se usa porque no se filtra
                    //int M_Locator_ID = Env.getContextAsInt( Env.getCtx(),m_WindowNo,"M_Locator_ID" );
                    String             title = "";
                    PAttributeInstance pai   = new PAttributeInstance( Env.getFrame( this ),title,M_Warehouse_ID,0,M_Product_ID,m_C_BPartner_ID,m_WindowNo );
            ...
            try {
            	...
            	if( M_Locator_ID != 0 ) {
            		if (columnName.endsWith("_To"))
                    	fireVetoableChange( "M_Locator_ID_To",null,M_Locator_ID);
            		if (columnName.endsWith("To_ID"))
                    	fireVetoableChange( "M_LocatorTo_ID",null,M_Locator_ID);
            		else
            			fireVetoableChange( "M_Locator_ID",null,M_Locator_ID);
                }
            } catch( PropertyVetoException pve ) {
                log.log( Level.SEVERE,"Error intentando setear ubicacion",pve );
            }
        }    // change
