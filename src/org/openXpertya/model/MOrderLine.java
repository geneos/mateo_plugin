...
public class MOrderLine extends X_C_OrderLine {
	...
	/**
	 * Variable usada para determinar si en una orden de compra pueden coexistir
	 * dos lineas con mismo producto 
	 **/
	private boolean allowRepeatedProduct = false;
...
//        }
    ...
    public void setAllowRepeatedProduct(boolean allowRepeatedProduct) {
		this.allowRepeatedProduct = allowRepeatedProduct;
	}
    
    public boolean isAllowRepeatedProduct() {
		return allowRepeatedProduct;
	}
    /**
     * Descripción de Método
     *
